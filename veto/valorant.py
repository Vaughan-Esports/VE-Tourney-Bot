...
from utils import player_utils, embeds
from utils.message_generators import *

from settings import *


async def bo1(ctx: discord.ext.commands.Context, bot: discord.ext.commands.Bot, main_message: discord.Message,
    ...
    for x in range(4):
        ...
        if x != 3:
            ...
            embed.set_field_at(1, name="Maps", value=valorant_maps_message(removed_maps))
        else:
            removed_maps.append(capwords(msg.content))
            # highlight last map
            selected_map = ""
            ...
            embed.set_field_at(1, name="Maps", value=valorant_maps_message(removed_maps, selected_map))
    ...
    # update winner embed
    embed.set_field_at(0, name=f"`                         Game 1                            `",
...
async def bo3(player1: discord.User, player2: discord.User):
    pass
